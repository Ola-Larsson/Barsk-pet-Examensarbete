...
export default function Home() {
  const [favorites, setFavorites] = React.useState<Drink[]>(randomOrderDrinks(drinks));
  const [popular, setPopular] = React.useState<Drink[]>(randomOrderDrinks(drinks));
  const [newDrinks, setNewDrinks] = React.useState<Drink[]>(randomOrderDrinks(drinks));
  const auth = useAuth();
